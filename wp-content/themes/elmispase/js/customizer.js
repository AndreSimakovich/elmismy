...
(function ( $ ) {
	...
	wp.customize( 'elmispase[elmispase_primary_color]', function ( value ) {
		value.bind( function ( primaryColor ) {
			// Store internal style for primary color
			var primaryColorStyle = '<style id="elmispase-internal-primary-color"> blockquote { border-left: 3px solid ' + primaryColor + '; }' +
			'.elmispase-button, input[type="reset"], input[type="button"], input[type="submit"], button { background-color: ' + primaryColor + '; }' +
			...
			$( 'head #elmispase-internal-primary-color' ).remove();

...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content clearfix">
		<?php
		if ( ( get_theme_mod( 'elmispase_featured_image_single_post_page', 0 ) == 1 ) && has_post_thumbnail() ) {
		...
		$elmispase_tag_list = get_the_tag_list( '', '&nbsp;&nbsp;&nbsp;&nbsp;', '' );
		if ( ! empty( $elmispase_tag_list ) ) {
			?>
			<div class="tags">
				<?php
				_e( 'Tagged on: ', 'elmispase' );
				echo $elmispase_tag_list;
				?>
			</div>
			<?php
		}

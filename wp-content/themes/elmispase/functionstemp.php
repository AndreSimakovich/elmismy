<?php
/**
 * Elmispase functions related to defining constants, adding files and WordPress core functionality.
 *
...
function elmispase_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'elmispase_custom_background_args', array(
...
define( 'ELMISPASE_IMAGES_DIR', ELMISPASE_PARENT_DIR . '/images' );
...
define( 'ELMISPASE_ADMIN_JS_DIR', ELMISPASE_ADMIN_DIR . '/js' );
...
define( 'ELMISPASE_IMAGES_URL', ELMISPASE_PARENT_URL . '/images' );
...
define( 'ELMISPASE_ADMIN_JS_URL', ELMISPASE_ADMIN_URL . '/js' );
...
if ( !function_exists( 'optionsframework_init' ) ) {
	...
	require_once( ELMISPASE_ADMIN_DIR . '/options/options-framework.php' );
}

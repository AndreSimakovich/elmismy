...
class elmispase_recent_work_widget extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			...
			'description'                 => __( 'Show your some pages as recent work. Best for Business Top or Bottom sidebar.', 'elmispase' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Featured Widget', 'elmispase' ), $widget_ops, $control_ops );
	}

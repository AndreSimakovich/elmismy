...
class elmispase_call_to_action_widget extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			...
			'description'                 => __( 'Use this widget to show the call to action section.', 'elmispase' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 200, 'height' => 250 );
		parent::__construct( false, $name = __( 'TG: Call To Action Widget', 'elmispase' ), $widget_ops, $control_ops );
	}

		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'elmispase_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'elmispase_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				attachEvents         : function () {
					...
					if (
						'elmispase_panel' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'elmispase_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'elmispase_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'elmispase_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="elmispase-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the Elmispase Upseel section only.
 */
(
	function ( $, api ) {
		api.sectionConstructor[ 'elmispase-upsell-section' ] = api.Section.extend(
			{

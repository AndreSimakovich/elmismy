...
( function ( $ ) {
	...
	wp.customize(
		'elmispase_footer_copyright_alignment_setting',
		function ( value ) {
			value.bind(
				function ( alignment ) {
	...
	wp.customize(
		'elmispase_main_footer_layout_display_type',
		function ( value ) {
			value.bind(
				function ( layout ) {
					var display_type = layout;
					...
					if ( display_type === 'type_two' ) {
						$( '#colophon' ).removeClass( 'elmispase-footer--classic-bordered' ).addClass( 'elmispase-footer--classic' );
					} else if ( display_type === 'type_three' ) {
						$( '#colophon' ).removeClass( 'elmispase-footer--classic' ).addClass( 'elmispase-footer--classic-bordered' );
					} else if ( display_type === 'type_one' ) {
						$( '#colophon' ).removeClass( 'elmispase-footer--classic elmispase-footer--classic-bordered' );
					}
				}
			);
		}

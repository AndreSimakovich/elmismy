 ...
 * Class Elmispase_Title_Control
 */
class Elmispase_Title_Control extends Elmispase_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<div class="elmispase-title-wrapper">

<?php
/**
 * Elmispase customizer base additional control class for theme customize options.
 *
 * Class Elmispase_Customize_Base_Additional_Control
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_Customize_Base_Additional_Control
 */
class Elmispase_Customize_Base_Additional_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_style_add_data( 'elmispase-customize-controls', 'rtl', 'replace' );

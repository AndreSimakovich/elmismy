<?php
/**
 * Elmispase customizer base control class for theme customize options.
 *
 * Class Elmispase_Customize_Base_Control
 *
 * @package    ThemeGrill
...
/**
 * Elmispase customizer base control class.
 *
 * Class Elmispase_Customize_Base_Control
 */
class Elmispase_Customize_Base_Control {
...
return new Elmispase_Customize_Base_Control();

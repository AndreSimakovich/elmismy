 ...
 *
 * Class Elmispase_Buttonset_Control
 */
class Elmispase_Buttonset_Control extends Elmispase_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elmispase-buttonset';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="elmispase-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>

 ...
 *
 * Class Elmispase_Sortable_Control
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_Sortable_Control
 */
class Elmispase_Sortable_Control extends Elmispase_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type       = 'elmispase-sortable';
	...
	protected function content_template() {
		...
		<ul class="unsortable">
			...
			<li {{{ data.inputAttrs }}} class='elmispase-sortable-item' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# }else { #>
			<li {{{ data.inputAttrs }}} class='elmispase-sortable-item invisible' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# } #>

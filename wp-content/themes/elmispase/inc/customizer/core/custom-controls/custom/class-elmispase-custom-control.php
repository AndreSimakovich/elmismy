 ...
 *
 * Class Elmispase_Custom_Control
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_Custom_Control
 */
class Elmispase_Custom_Control extends Elmispase_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="elmispase-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="elmispase-custom-links">

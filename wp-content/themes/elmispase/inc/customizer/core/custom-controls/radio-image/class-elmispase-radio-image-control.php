 ...
 *
 * Class Elmispase_Radio_Image_Control
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_Radio_Image_Control
 */
class Elmispase_Radio_Image_Control extends Elmispase_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elmispase-radio-image';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="image image-col-{{{ data.image_col }}}">
			...
			<label for="{{ data.id }}{{ key }}" {{{ data.labelStyle }}} class="elmispase-radio-image">

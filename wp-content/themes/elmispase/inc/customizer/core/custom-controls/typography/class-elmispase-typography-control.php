 ...
 *
 * Class Elmispase_Typography_Control
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_Typography_Control
 */
class Elmispase_Typography_Control extends Elmispase_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elmispase-typography';
	...
	public function enqueue() {
		...
		$google_font_subsets = Elmispase_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'elmispase' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'elmispase' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'elmispase' );
			$localize_scripts['custom']           = $custom_fonts;
		}

		// Loading available fonts.
		wp_localize_script(
			'elmispase-customize-controls',
			'ElmispaseCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'elmispase-customize-controls',
			'ElmispaseCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = Elmispase_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = Elmispase_Fonts::get_system_fonts();
		$standard_fonts_array = array();
		$default_variants     = $this->format_variants_array(
			apply_filters(
				'elmispase_default_variants',
				array(
					'regular',
					'italic',
				)
	...
	public function get_google_fonts() {
		...
		$google_fonts          = Elmispase_Fonts::get_google_fonts();
		$font_variants         = Elmispase_Fonts::get_font_variants();
		$foogle_fonts__subsets = Elmispase_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = Elmispase_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = Elmispase_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'elmispase' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elmispase-font-size-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elmispase-font-size-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elmispase-font-size-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'elmispase' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elmispase-line-height-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elmispase-line-height-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elmispase-line-height-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'elmispase' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elmispase-letter-spacing-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elmispase-letter-spacing-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elmispase-letter-spacing-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'elmispase' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'elmispase' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'elmispase' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'elmispase' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'elmispase' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'elmispase' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'elmispase' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'elmispase' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'elmispase' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'elmispase' ); ?></span>
				<div class="elmispase-field-content">
					<select {{{ data.inputAttrs }}} id="elmispase-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'elmispase' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'elmispase' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'elmispase' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'elmispase' ); ?></option>
						<option value="initial"

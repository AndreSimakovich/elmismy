...
/**
 * Class Elmispase_Dimensions_Control
 */
class Elmispase_Dimensions_Control extends Elmispase_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elmispase-dimensions';

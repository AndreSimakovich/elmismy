<?php
/**
 * Elmispase customizer class for theme customize sanitizes.
 *
 * Class Elmispase_Customizer_FrameWork_Sanitizes
 *
 * @package    ThemeGrill
...
/**
 * Elmispase customizer class for theme customize callbacks.
 *
 * Class Elmispase_Customizer_FrameWork_Sanitizes
 */
class Elmispase_Customizer_FrameWork_Sanitizes {
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = Elmispase_Fonts::get_google_font_subsets();

...
class Elmispase_Customize_Base_Option {

	public function __construct() {

		// Register the customize panels, sections and controls.
		add_filter( 'elmispase_customizer_options', array( $this, 'register_options' ), 10, 2 );
	...
	public function get_section_description( $args ) {
		...
		// Description.
		$content  = '<div class="elmispase-section-description">';
...
return new Elmispase_Customize_Base_Option();

 ...
 *
 * Class Elmispase_WP_Customize_Section
 *
 * @package    ThemeGrill
 ...
 * Class Elmispase_WP_Customize_Section
 */
class Elmispase_WP_Customize_Section extends WP_Customize_Section {
	...
	public function json() {
		...
		if ( $this->panel ) {
			$array['customizeAction'] = sprintf(
				...
				esc_html__( 'Customizing &#9656; %s', 'elmispase' ),
				esc_html( $this->manager->get_panel( $this->panel )->title )
			);
		} else {
			$array['customizeAction'] = esc_html__( 'Customizing', 'elmispase' );
		}

...
$wp_customize->get_section( 'header_image' )->panel    = 'elmispase_header_panel';
...
$wp_customize->get_control( 'background_color' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_color' )->type     = 'elmispase-color';
$wp_customize->get_control( 'background_color' )->priority = 20;

$wp_customize->get_control( 'background_image' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_image' )->priority = 25;

$wp_customize->get_control( 'background_preset' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_preset' )->priority = 30;

$wp_customize->get_control( 'background_position' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_position' )->priority = 35;

$wp_customize->get_control( 'background_size' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_size' )->priority = 40;

$wp_customize->get_control( 'background_repeat' )->section  = 'elmispase_global_background_section';
$wp_customize->get_control( 'background_repeat' )->priority = 45;

$wp_customize->get_control( 'background_attachment' )->section  = 'elmispase_global_background_section';
...
$wp_customize->get_control( 'header_textcolor' )->type      = 'elmispase-color';
$wp_customize->get_control( 'header_textcolor' )->priority  = 20;

// Header media options.
$wp_customize->get_section( 'header_image' )->panel    = 'elmispase_header_options';

 ...
 */
if ( ! is_active_sidebar( 'elmispase_footer_sidebar_one' ) &&
     ! is_active_sidebar( 'elmispase_footer_sidebar_two' ) &&
     ! is_active_sidebar( 'elmispase_footer_sidebar_three' ) &&
     ! is_active_sidebar( 'elmispase_footer_sidebar_four' ) ) {
	return;
}

if ( get_theme_mod( 'elmispase_footer_widget_column_select_type', 'four' ) == 'one' ) {
	$footer_column_one   = 'tg-column-full';
	$footer_column_two   = '';
	$footer_column_three = '';
	$footer_column_four  = '';
} elseif ( get_theme_mod( 'elmispase_footer_widget_column_select_type', 'four' ) == 'two' ) {
	$footer_column_one   = 'tg-one-half';
	$footer_column_two   = 'tg-one-half tg-one-half-last';
	$footer_column_three = '';
	$footer_column_four  = '';
} elseif ( get_theme_mod( 'elmispase_footer_widget_column_select_type', 'four' ) == 'three' ) {
	...
	$footer_column_four  = '';
} elseif ( get_theme_mod( 'elmispase_footer_widget_column_select_type', 'four' ) == 'four' ) {
	...
	<div class="inner-wrap">
		<div class="footer-widgets-area clearfix">
			<div class="<?php echo $footer_column_one; ?>">
				...
				if ( ! dynamic_sidebar( 'elmispase_footer_sidebar_one' ) ):
				endif;
				?>
			</div>
			<?php if ( $footer_column_two != '' ) { ?>
				<div class="<?php echo $footer_column_two; ?>">
					<?php
					// Calling the footer sidebar if it exists.
					if ( ! dynamic_sidebar( 'elmispase_footer_sidebar_two' ) ):
					endif;
					?>
				</div>
			<?php } ?>
			<?php if ( $footer_column_three != '' ) { ?>
				<div class="<?php echo $footer_column_three; ?>">
					<?php
					// Calling the footer sidebar if it exists.
					if ( ! dynamic_sidebar( 'elmispase_footer_sidebar_three' ) ):
					endif;
					?>
				</div>
			<?php } ?>
			<?php if ( $footer_column_four != '' ) { ?>
				<div class="<?php echo $footer_column_four; ?>">
					<?php
					// Calling the footer sidebar if it exists.
					if ( ! dynamic_sidebar( 'elmispase_footer_sidebar_four' ) ):
					endif;
					?>
				</div>
			<?php } ?>

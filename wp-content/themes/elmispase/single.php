	...
	<div id="primary">
		<div id="content" class="clearfix">
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( get_theme_mod( 'elmispase_related_posts_activate', 0 ) == 1 ) {
				get_template_part( 'inc/related-posts' );
				}
				?>

				<?php
				if ( get_theme_mod( 'elmispase_author_bio', 0 ) == 1 ) :
				...
				<?php
					do_action( 'elmispase_before_comments_template' );
					// If comments are open or we have at least one comment, load up the comment template
					if ( comments_open() || '0' != get_comments_number() )
						comments_template();
	      		do_action ( 'elmispase_after_comments_template' );
				?>

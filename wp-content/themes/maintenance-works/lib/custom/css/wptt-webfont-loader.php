...
if ( ! function_exists( 'maintenance_works_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function maintenance_works_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'maintenance_works_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function maintenance_works_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}

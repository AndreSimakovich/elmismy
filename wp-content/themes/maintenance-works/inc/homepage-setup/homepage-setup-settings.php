...
$maintenance_works_theme_title = $maintenance_works_current_theme->get( 'Name' );
...
$config['maintenance_works_page_slug'] 	= 'maintenance-works';
$config['maintenance_works_page_title']	= 'Homepage Setup';
 ...
 **/
if( class_exists( 'Maintenance_Works_Whizzie' ) ) {
	$Maintenance_Works_Whizzie = new Maintenance_Works_Whizzie( $config );
}